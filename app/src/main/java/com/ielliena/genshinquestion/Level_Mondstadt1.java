...
public class Level_Mondstadt1 extends AppCompatActivity {
    ...
    protected void setQuestions() {
        ...
        questionText.setText(array.questions_venti[questionNumber]);

        numAnswer1 = random.nextInt(4);
        answer1.setText(array.answers_venti[questionNumber][numAnswer1]);

        numAnswer2 = random.nextInt(4);
        while(numAnswer1 == numAnswer2) numAnswer2 = random.nextInt(4);
        answer2.setText(array.answers_venti[questionNumber][numAnswer2]);

        numAnswer3 = random.nextInt(4);
        while(numAnswer3 == numAnswer2 || numAnswer3 == numAnswer1) numAnswer3 = random.nextInt(4);
        answer3.setText(array.answers_venti[questionNumber][numAnswer3]);
        ...
        answer4.setText(array.answers_venti[questionNumber][numAnswer4]);
    }
    ...
    protected void callDialog() {
        ...
        modalEndText.setText(R.string.venti_phrase);
        modalEndImage.setImageResource(R.drawable.venti_modal);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level_venti);
