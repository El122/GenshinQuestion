...
public class Level_Mondstadt_Diluc extends AppCompatActivity {
    ...
    protected void setQuestions() {
        ...
        questionText.setText(array.questions_diluc[questionNumber]);

        numAnswer1 = random.nextInt(4);
        answer1.setText(array.answers_diluc[questionNumber][numAnswer1]);

        numAnswer2 = random.nextInt(4);
        while(numAnswer1 == numAnswer2) numAnswer2 = random.nextInt(4);
        answer2.setText(array.answers_diluc[questionNumber][numAnswer2]);

        numAnswer3 = random.nextInt(4);
        while(numAnswer3 == numAnswer2 || numAnswer3 == numAnswer1) numAnswer3 = random.nextInt(4);
        answer3.setText(array.answers_diluc[questionNumber][numAnswer3]);
        ...
        answer4.setText(array.answers_diluc[questionNumber][numAnswer4]);
    }

    public void backToLevelsMenu() {
        try {
            Intent intent = new Intent(Level_Mondstadt_Diluc.this, GameLevels_Mondstadt.class);
    ...
    protected void checkAnswer(int clickedButton) {
        ...
        final Animation a = AnimationUtils.loadAnimation(Level_Mondstadt_Diluc.this, R.anim.alpha);
    ...
    protected void callDialog() {
        ...
        modalEndText.setText(R.string.diluc_phrase);
        modalEndImage.setImageResource(R.drawable.diluc_modal);
        ...
        nextLevel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level_Mondstadt_Diluc.this, Level_Mondstadt_Lisa.class);
                    startActivity(intent);
                    finish();
                } catch (Exception e) {}
                modalEnd.dismiss();
    ...
    protected void saveResult() {
        ...
        editor.putInt("Diluc", trueAnswers);
        editor.commit();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level_diluc);
